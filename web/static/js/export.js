function exportarAPowerPoint() {
  ...
  html2canvas(contenidoDiv).then((canvas) => {
    ...
    pptx.writeFile({ fileName: "Divisiones (Tipo de Procedimiento).pptx" });
  });
}
...
function exportarAPowerPointTwo() {
  ...
  html2canvas(contenidoDiv).then((canvas) => {
    ...
    // Generar y descargar el archivo PowerPoint
    pptx.writeFile({ fileName: "Divisiones (Parroquias).pptx" });
  });
}
...
function exportarAPowerPointFive() {
  ...
  html2canvas(contenidoDiv).then((canvas) => {
    ...
    // Generar y descargar el archivo PowerPoint
    pptx.writeFile({ fileName: "Tipo de procedimiento (Divisiones).pptx" });
  });
}
function exportarAPowerPointSix() {
  ...
  html2canvas(contenidoDiv).then((canvas) => {
    ...
    // Generar y descargar el archivo PowerPoint
    pptx.writeFile({ fileName: "Tipo de Procedimiento (Parroquias).pptx" });
  });
}
function exportarAPowerPointSeven() {
  ...
  html2canvas(contenidoDiv).then((canvas) => {
    ...
    // Generar y descargar el archivo PowerPoint
    pptx.writeFile({ fileName: "Divisiones (Tipo de Procedimientos).pptx" });
  });
}
function exportarAPowerPointEight() {
  const contenidoDiv = document.getElementById("graphic-eigth");
...
function exportarAPowerPointNueve() {
  const contenidoDiv = document.getElementById("bar");
  ...
  html2canvas(contenidoDiv).then((canvas) => {
    ...
    // Generar y descargar el archivo PowerPoint
    pptx.writeFile({ fileName: "Grafica de Barras (Divisiones).pptx" });
  });
}

function exportarAPowerPointDiez() {
  const contenidoDiv = document.getElementById("bar-horizontal");
  ...
  html2canvas(contenidoDiv).then((canvas) => {
    ...
    // Generar y descargar el archivo PowerPoint
    pptx.writeFile({ fileName: "Grafica de Barras Horizontal (Procedimientos).pptx" });
  });
}
