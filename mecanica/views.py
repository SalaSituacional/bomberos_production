...
from .forms import Reportes, Cambiar_Estado, Cambiar_Division, Unidades_Informacion, HerramientaForm, AsignacionForm, InventarioForm, ConductorForm, CertificadoMedicoFormSet, LicenciaFormSet, DevolucionHerramientaForm
from .models import *
